...
//    if (ms != nullptr)
//        printf("SIM %d RANK %d/%d PID %d. Wait for 10 seconds\n", ms->simulationIndex_, cr->sim_nodeid, cr->nnodes, getpid());
//    else
//        printf("RANK %d/%d PID %d. Wait for 10 seconds\n", cr->sim_nodeid, cr->nnodes, getpid());
//    usleep(10000000);
